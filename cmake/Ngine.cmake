...
function(ngine_add_game)
    ...
    if(${PLATFORM} MATCHES "UWP")
        ...
        if (NOT GAME_UWP_PACKAGE_STORE_ASSOCIATION_PATH OR "${GAME_UWP_PACKAGE_STORE_ASSOCIATION_PATH}" STREQUAL "")
            set (GAME_ADDITIONAL_FILES ${GAME_ADDITIONAL_FILES} ${GAME_UWP_PACKAGE_STORE_ASSOCIATION_PATH})
        endif()

        if (NOT GAME_UWP_PACKAGE_STORE_KEY OR "${GAME_UWP_PACKAGE_STORE_KEY}" STREQUAL "")
