...
namespace ngine::graphics {
    ...
    enum class CoordinateSystem {
        /**
         * Screen coordinates go from (0, 0) to (screenWidth, screenHeight). With (0, 0) in the bottom left.
         *
         * All draw calls with origin (0, 0) will assume position as bottom left.
         */
        Screen,

        /**
         * GUI coordinates go from (0, 0) to (screenWidth, screenHeight). With (0, 0) in the top left.
         *
