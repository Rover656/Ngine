...
namespace ngine::graphics {
    /**
     * The vertex data converter converts other `PrimitiveType`'s to triangles,
     * by creating indices for them. One day I may add vertex optimisation...
     */
    ...
    public:
         ...
         */
        static int getTriangleIndices(PrimitiveType currentType,
                                      int vertexCount,
