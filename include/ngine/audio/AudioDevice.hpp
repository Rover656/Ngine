...
namespace ngine::audio {
    ...
    class NEAPI AudioDevice {
         ...
         */
        static ma_uint32 _audioBufferDSPRead(ma_pcm_converter *pDSP,
                                             void *pFramesOut,
         ...
         */
        static void _logCallback(ma_context *pContext, ma_device *pDevice,
         ...
         */
        static void _mixAudioFrames(float *framesOut, const float *framesIn,
         ...
         * @param frameCount Frame count.
         */
        static void _sendAudioDataToDevice(ma_device *pDevice, void *pFramesOut,
    ...
    public:
         ...
         *
         * @warning Normally called by Game, don't use unless reimplementing
         * Game or reinitialising audio.
         */
        static void close();
         ...
         */
        static AudioBuffer *initAudioBuffer(ma_format format,
                                            ma_uint32 channels,
         ...
         */
        static AudioStream initAudioStream(unsigned int sampleRate,
