...
namespace ngine::physics {
    /**
     * The physics context defines how units are handled in the underlying
     * physics engine.
     */
    ...
    public:
         ...
         */
        template <typename T> T convertPixelsToMeters(T pixels) const {
         ...
         */
        template <typename T> T convertMetersToPixels(T meters) const {
