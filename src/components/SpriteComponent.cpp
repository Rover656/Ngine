...
namespace ngine::components {
    ...
    graphics::Sprite *SpriteComponent::getSprite() const {
        return m_sprite;
    }
    ...
    void SpriteComponent::setOffset(Vector2 offset) {
        m_offset = offset;
    }
    ...
    graphics::Color SpriteComponent::getColor() const {
        return m_color;
    }

    void SpriteComponent::setColor(graphics::Color color) {
        m_color = color;
    }
