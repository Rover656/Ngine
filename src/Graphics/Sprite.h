...
namespace NerdThings::Ngine::Graphics {
    ...
    public:
         ...
         */
        TSprite(const std::vector<std::shared_ptr<TTexture2D>> &textures_, float imageSpeed_ = 30, int startingFrame_ = 0);
         ...
         */
        void SetTextures(const std::vector<std::shared_ptr<TTexture2D>> &textures_);
