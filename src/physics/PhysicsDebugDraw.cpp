...
namespace ngine::physics {
    ...
    void PhysicsDebugDraw::DrawSolidPolygon(const b2Vec2 *vertices,
        ...
        for (auto i = 0; i < vertexCount; i++) {
            verts.push_back(m_context->convertMetersToPixels(
                Vector2(vertices[i].x, vertices[i].y)));
        }

        // Draw
        graphics::Color fill = {color.r * 0.5f, color.g * 0.5f, color.b * 0.5f,
                                color.a * 0.5f};
        graphics::ShapeRenderer::drawPolygon(m_renderer, Vector2::Zero, verts,
                                             fill);
    }
    ...
    void PhysicsDebugDraw::DrawCircle(const b2Vec2 &center, float radius,
        ...
        graphics::ShapeRenderer::drawCircle(
            m_renderer, c, r,
    ...
    void PhysicsDebugDraw::DrawSolidCircle(const b2Vec2 &center, float radius,
        ...
        graphics::ShapeRenderer::drawLine(m_renderer, c, p,
    ...
    void PhysicsDebugDraw::DrawSegment(const b2Vec2 &p1, const b2Vec2 &p2,
        ...
        graphics::ShapeRenderer::drawLine(m_renderer, v1, v2,
                                          {color.r, color.g, color.b, color.a});
    }
    ...
    void PhysicsDebugDraw::DrawPoint(const b2Vec2 &p, float size,
        ...
        graphics::ShapeRenderer::drawRectangle(
            m_renderer, rect, {color.r, color.g, color.b, color.a});
    }
} // namespace ngine::physics
